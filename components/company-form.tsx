      ...
      {tab === 'info' && (
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input placeholder="Add alias and press Enter" value={aliasInput} onChange={e => setAliasInput(e.target.value)} onKeyDown={handleAliasKeyDown} onBlur={addAlias} />
            <p className="text-xs text-muted-foreground">Alternative names (e.g. abbreviations, trading names).</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input placeholder="Add tag and press Enter (e.g. Fund I)" value={tagInput} onChange={e => setTagInput(e.target.value)} onKeyDown={handleTagKeyDown} onBlur={addTag} />
          </div>

          <div className="space-y-2">
            <Label htmlFor="stage">Stage</Label>
            <Input id="stage" placeholder="Series A" value={stage} onChange={e => setStage(e.target.value)} />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input placeholder="Add industry and press Enter (e.g. SaaS)" value={industryInput} onChange={e => setIndustryInput(e.target.value)} onKeyDown={handleIndustryKeyDown} onBlur={addIndustry} />
          </div>
