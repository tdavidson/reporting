...
Fixed
- **The installable icon is sharp.** The mark was drawn at a fractional scale and centred on a half pixel, so most of its ink rasterised as half-covered grey — worst at the sizes a phone actually installs. It is now snapped to whole pixels at every size, and the app offers an exact icon for each install slot (152/167/180 for iOS, 192/384/512/1024 for Android and desktop) instead of leaving the platform to resize one
