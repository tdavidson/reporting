...
/**
 * The client half of the public layout: the signed-in redirect, header, footer
 * and analytics. layout.tsx (a server component) wraps this in the marketing
 * page's typeface, read from site_content, so header and footer switch with
 * the page rather than staying in the app's default.
 */
