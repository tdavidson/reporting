...
const steps: { icon: LucideIcon; step: string; title: string; text: string; href: string; screenshot?: string }[] = [
  ...
  { icon: Calculator, step: '11', title: 'Keep the books on your fund', text: 'An optional double-entry ledger per vehicle - fund, SPV, direct deal, or GP entity. Import a bank feed, book capital calls and distributions, and close a period to allocate income and expenses to each partner’s capital account, accruing note interest and carried interest as you go. Produces capital account statements, a schedule of investments, and full financial statements that tie to the ledger. Vehicles you don’t keep books on can record LP capital directly and still produce the same statements.', href: '/accounting-explainer' },
