...
const faqs: { q: string; a: React.ReactNode }[] = [
  ...
  { q: 'What AI models are supported?', a: 'The platform supports Anthropic (Claude), OpenAI (GPT), and OpenRouter. You bring your own API key and can switch between providers. AI powers metric extraction from emails, company summaries, portfolio analysis chat, and LP letter drafting.' },
