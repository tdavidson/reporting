    ...
    <div className="p-4 md:py-8 md:pl-8 md:pr-4 w-full">
      ...
      <div className="mb-6 space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Balance sheet, income statement, statement of changes in partners&rsquo; capital, and
          statement of cash flows — all derived from the ledger. Use <em>As of</em> to view them at
          any date.
        </p>
      </div>
      <StatementsView />
