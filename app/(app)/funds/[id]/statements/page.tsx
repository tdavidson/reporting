...
export default async function StatementsPage(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="pt-4 md:pt-8 pb-8 w-full">
      <FundSubpageChrome
        ...
        description="Consolidated operations, cash flows, and changes in partners capital"
        vehicle={vehicle}
        vehicleId={vehicleId}
      >
        <StatementsView />
